...
ใช้ **Agent tool** โดยตรง — **prompt ต้องมี role definition ครบถ้วน inline** เสมอ เพื่อ override Lead behavior จาก CLAUDE.md:
...
> **เหตุผล:** subagent โหลด CLAUDE.md ของ agent-teams ซึ่งบอกว่า "คุณเป็น Lead" — ถ้าไม่ใส่ inline override ใน prompt, subagent จะ spawn ตัวเองซ้ำแทนที่จะทำงานเป็น specialist
