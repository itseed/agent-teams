...
ห้ามทำ:
- `tmux split-window` หรือสร้าง pane ใหม่ใดๆ — agents ทำงานอยู่แล้วใน pane เดิม
...
> **หมายเหตุ**: ไม่จำเป็นต้อง spawn ครบทั้ง 8 ตัวทุกครั้ง — spawn เฉพาะ role ที่จำเป็นต่องานจริง
