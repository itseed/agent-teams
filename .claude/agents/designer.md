...
```
SendMessage(to: "<teammate-name>", message: "design spec พร้อมแล้ว: ...")
```
...
- Log ทุกการสื่อสาร:
```bash
echo "[designer → frontend]: ส่ง component spec แล้ว" >> /tmp/agent-logs/designer.log
echo "[designer ← frontend]: ขอ design tokens" >> /tmp/agent-logs/designer.log
```
