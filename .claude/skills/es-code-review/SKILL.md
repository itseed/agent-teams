---
name: es-code-review
description: ใช้เมื่อต้อง review โค้ดก่อน merge — ตรวจ diff/PR, ประเมินว่าโค้ดปลอดภัย/ดีพอจะ merge ไหม, หรือเมื่อ reviewer agent ได้รับงานตรวจโค้ด แม้ผู้ใช้พูดแค่ "ดู PR นี้ให้หน่อย" หรือ "โค้ดนี้ใช้ได้ยัง" ครอบคลุม stack NestJS / Next.js / Flutter / LINE LIFF / PostgreSQL
---
