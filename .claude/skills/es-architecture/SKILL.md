...
**โหลด `references/stacks.md` แล้วอ่านเฉพาะ section ของ stack ที่เกี่ยวกับ feature นี้** (NestJS / Next.js / Flutter / React Native / LINE LIFF / PostgreSQL) — อย่าออกแบบจากความจำ
